...
const AINurse = () => {
  const embedUrl = 'https://copilotstudio.microsoft.com/environments/Default-a8f249fb-91ee-4dd5-bf60-d1ec1330b078/bots/data_demeSathi/webchat?__version__=2';

  return (
    <WebView
      source={{ uri: embedUrl }}
      style={{ flex: 1 }}
      javaScriptEnabled={true} // Enable JavaScript if required by your chatbot
      domStorageEnabled={true} // Enable DOM Storage for handling cookies and local storage
